...
import { View, Text, FlatList, Alert, ImageBackground, TouchableOpacity, Dimensions, ActivityIndicator, Pressable } from "react-native";
...
// Router and State values
  ...
  const getReasons = async() => {
    try {
      setIsLoading(true);
      const response = await fetch(`http://10.150.38.124:3001/reasons`)
  ...
  return (
    ...
    >
      <View style={styles.arrowContainer}>
        ...
        <Pressable 
          style={[styles.arrowButton, styles.disabledArrow]} 
          disabled={true}
        >
